...
The layout of the visualization will be a dashboard made up of two charts. There will be a drop-down so that the user can select a financial index to view and this drop-down will update the two charts. I am also including another drop-down so that the user can determine if they want to only see data from a recession or a non-recession period, which will also update the two charts. 
